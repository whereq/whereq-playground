...
/**
 * 
 * Invoke getter/setter, access private attributes, invoke private methods, get generic class type, get the real class behind AOP.
 * 
 * @author bacon
 */
public class Reflections {
	...
	/**
	 * Invoke Setter, only match the method name
	 */
